...
/**
 * Servlet implementation class WscGen
 */
@WebServlet("/wscgen")
public class WscGen extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String url = "https://api.github.com/repos/GIPSY-dev/WSC-Gen/events";
		try {
			...
			awsUtils.putJSON(latestNews, "wscGen.json");
