...
/**
 * Servlet implementation class Cciff
 */
@WebServlet("/cciff")
public class Cciff extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String url = "https://graph.facebook.com/v2.11/1504317536536823/feed";
		...
		try {
			...
			awsUtils.putJSON(latestNews, "cciff.json");
